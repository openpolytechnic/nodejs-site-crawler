...
module.exports.controller = function(app) {
     ...
     * a home page route
     */
    app.get('/course/:resultid/:tag/:offset?', function(req, res) {
                ...
                ResultItem.find(filter)
                    ...
                    .exec(function(error, items) {
                        ...
                        var pagination = {total: total,
                            baseurl: '/course/'+req.params.resultid+'/'+req.params.tag,
                            offset: offset,
                            limit: limit,
                        ...
                        if (error) {
                            ...
                            res.render('course', {app_name: app.get('name'),
                                title: 'Contents In this Group',
                                resultid: req.params.resultid,
